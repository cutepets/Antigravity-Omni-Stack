...
exports.KNOWN_PERMISSION_CODES = exports.ALL_PERMISSION_CODES = exports.LEGACY_PERMISSION_ALIASES = exports.PERMISSION_GROUPS = void 0;
exports.isKnownPermission = isKnownPermission;
exports.expandPermissionCodes = expandPermissionCodes;
...
exports.ALL_PERMISSION_CODES = exports.PERMISSION_GROUPS.flatMap((group) => group.permissions.map((permission) => permission.code));
exports.KNOWN_PERMISSION_CODES = [...new Set([...exports.ALL_PERMISSION_CODES, ...Object.keys(exports.LEGACY_PERMISSION_ALIASES)])];
function isKnownPermission(code) {
    return exports.KNOWN_PERMISSION_CODES.includes(code);
}
function expandPermissionCodes(codes) {
    ...
    const visit = (code) => {
        if (resolved.has(code))
            return;
        resolved.add(code);
        for (const child of exports.LEGACY_PERMISSION_ALIASES[code] ?? []) {
            visit(child);
        }
    };
