        ...
        items: activeTab.cart.map((ci) => ({
          ...
          hotelDetails: ci.hotelDetails
            ? {
              ...
              careMode: ci.hotelDetails.careMode,
              packageKind: ci.hotelDetails.packageKind,
              packageTotalDays: ci.hotelDetails.packageTotalDays,
              packageStartDate: ci.hotelDetails.packageStartDate,
              packageEndDate: ci.hotelDetails.packageEndDate,
              autoCompleteAt: ci.hotelDetails.autoCompleteAt,
