...
export function TabRolesPermissions() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
        ...
        {/* Detail panel */}
        <div className="rounded-2xl border border-border/50 bg-background-secondary p-6">
            ...
            <>
              ...
              <div className="mt-5 space-y-3">
                {filteredGroups.map((group) => {
                  ...
                  return (
                    <div key={group.key} className="overflow-hidden rounded-xl border border-border/50">
                      <div className="bg-background-elevated/70 px-4 py-3">
                        <div className="flex items-center gap-3">
                          <input
                            type="checkbox"
                            checked={allChecked}
                        ...
                        {!isExpanded ? (
                          <p className="mt-2 truncate pl-7 text-xs italic text-foreground-muted">
                      ...
                      {isExpanded ? (
                        <div className="border-t border-border/40 bg-background-base px-4 py-3">
                            ...
                            {group.permissions.map((permission) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="min-w-0">
                                    <p className="text-[13px] font-medium leading-tight text-foreground-base">
                                      {permission.label}
                                    </p>
                                    <p className="mt-0.5 break-all text-[10px] text-foreground-muted">
                                      {permission.code}
                                    </p>
                                  </div>
                                </label>
                ...
                {filteredGroups.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-border/60 px-6 py-10 text-center text-sm text-foreground-muted">
