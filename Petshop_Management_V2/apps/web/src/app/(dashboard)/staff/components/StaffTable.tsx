...
export function StaffTable({ staffList, canEdit, canDeactivate, onEdit, onDeactivate }: StaffTableProps) {
  return (
              ...
              staffList.map((staff) => {
                ...
                return (
                  <tr key={staff.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                    ...
                    <td style={{ padding: '16px' }}>
                      <div style={{ fontSize: 14, color: '#334155' }}>Điện thoại: {staff.phone || '---'}</div>
                      <div style={{ marginTop: 4, fontSize: 13, color: '#64748b' }}>Email: {staff.email || '---'}</div>
                    </td>
                    <td style={{ padding: '16px' }}>
                      <span
                        style={{
                      ...
                      {canEdit ? (
                        <button
                          ...
                          style={{
                            ...
                            cursor: 'pointer',
                            fontWeight: 600,
                            marginRight: canShowDeactivate ? 16 : 0,
                          }}
                        >
                          Sửa
                        </button>
