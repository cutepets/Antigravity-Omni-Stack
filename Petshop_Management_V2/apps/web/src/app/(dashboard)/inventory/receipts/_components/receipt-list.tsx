          ...
          selectedRowIds.size > 0 ? (
            <DataListBulkBar selectedCount={selectedRowIds.size} onClear={clearSelection}>
              ...
              >
                ...
                <option value="FULL_RECEIVED">Đã nhập đủ</option>
                <option value="PARTIAL_RECEIVED">Nhập dở</option>
                <option value="SHORT_CLOSED">Chốt thiếu</option>
              ...
              {isSuperAdmin() ? (
                <button
                  ...
                  title="Xóa DB"
                  onClick={async () => {
                    if (await confirmDialog(`Xóa vĩnh viễn ${selectedReceiptIds.length} phiếu nhập đã chọn?`)) {
