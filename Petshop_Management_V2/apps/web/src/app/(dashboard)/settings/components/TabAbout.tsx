...
const APP_DESCRIPTION = `Petshop Management V2 là hệ thống quản lý tổng hợp dành cho chuỗi cửa hàng thú cưng.
Tích hợp POS bán hàng, quản lý kho, dịch vụ spa/grooming, khách sạn thú cưng,
quản lý nhân sự, và báo cáo tài chính trong một nền tảng duy nhất.`
...
const MODULES = [
    ...
    { name: 'Khách sạn thú cưng', color: 'text-amber-500' },
...
const CHANGELOG: ChangeLogEntry[] = [
    {
        ...
        date: '2026-04-24',
        changes: [
            'Thêm tab Giới thiệu và Xóa dữ liệu demo trong Cài đặt',
            'Deploy VPS với Docker + Nginx + SSL',
            'Hỗ trợ Việt hóa toàn bộ giao diện',
        ],
    },
    {
        version: '2.4.0',
