...
const BASE_PRODUCT_EXCEL_COLUMNS: ProductExcelColumn[] = [
  ...
  { key: 'attributeName2', header: 'Ten phan loai 2', width: 18 },
  ...
  { key: 'category', header: 'Danh muc', width: 18 },
  { key: 'brand', header: 'Thuong hieu', width: 18 },
  { key: 'importName', header: 'Ten nhap', width: 20 },
  { key: 'isActive', header: 'Dang ban', width: 12 },
  { key: 'imageUrl', header: 'Anh link', width: 28 },
