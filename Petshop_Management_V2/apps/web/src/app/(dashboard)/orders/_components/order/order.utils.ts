    ...
    items: (order.items ?? []).map((item: any) => ({
      ...
      hotelDetails: item.hotelDetails
        ? {
          ...
          careMode: item.hotelDetails.careMode ?? 'BOARDING',
          packageKind: item.hotelDetails.packageKind ?? 'NONE',
          packageTotalDays: item.hotelDetails.packageTotalDays,
          packageStartDate: item.hotelDetails.packageStartDate,
          packageEndDate: item.hotelDetails.packageEndDate,
          autoCompleteAt: item.hotelDetails.autoCompleteAt,
    ...
    items: draft.items.map((item) => ({
      ...
      hotelDetails: item.hotelDetails
        ? {
          ...
          careMode: item.hotelDetails.careMode,
          packageKind: item.hotelDetails.packageKind,
          packageTotalDays: item.hotelDetails.packageTotalDays,
          packageStartDate: item.hotelDetails.packageStartDate,
          packageEndDate: item.hotelDetails.packageEndDate,
          autoCompleteAt: item.hotelDetails.autoCompleteAt,
